                  ...
                  >
                    <Paper className={classes.paperbodydetail}>
                      <p>
                        ...
                        <h2 >
                          <a className="contact" href="https://www.linkedin.com/in/zacharygo/">
                            LinkedIn
                          </a>
                          <a className="contact" href="https://github.com/PixelCook">GitHub</a>
                        </h2>
                    ...
                    <Grid item xs={12} sm={3}>
                      <Paper className={classes.paperbody}>
                        ...
                        <ul className="list">
                          ...
                          <li>
                            <h3>UNIVERSIDAD DE CONCEPCION</h3> Print and
